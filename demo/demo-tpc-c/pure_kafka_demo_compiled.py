...
CACHE_DIR = os.path.join(script_path, f"{data_folder}_cache_{tag}_compiled")
...
def populate_customer(styx):
    def builder():
        ...
        for k, vals in idx_buf.items():
            ...
            # Compiled operator stores customers as a dict field (not a raw list)
            idx_parts[part][k] = {'customers': [v[1] for v in sorted(vals)]}
...
if __name__ == "__main__":
    ...
    print()
    kafka_output_consumer.main(SAVE_DIR, g)
